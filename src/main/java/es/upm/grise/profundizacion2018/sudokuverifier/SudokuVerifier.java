...
public class SudokuVerifier 
{
    ...
    /***
     *
    * Method to save sudoku in matrix and to check Rule 1: A cell in a Sudoku game
    * can only store positive digits, i.e. 1…9.
    */
                ...
                for (int jGridActual=0;jGridActual<3;jGridActual++){  
                    for (int i=0;i<3;i++){
                        for (int j=0;j<3;j++){                       
                            ...
                            //It has to be a number between 1 and 9, not 0.
                            if (aux!=0)
                                sudoku[iGridActual*3+i][jGridActual*3+j]=aux;
                            else
    ...
    /***
    * Method to check Rule 2: All digits appear only once in a sub-grid, i.e. 
    * they cannot repeat.
    */
    ...
    /***
    * Method to check Rule 3: A digit can appear only once in the rows of the 
    * global grid.
    */
    ...
    /***
    * Method to check Rule 4: A digit can appear only once in the columns of the 
    * global grid.
    */
